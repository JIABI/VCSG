function [ y, dzdw,dzdb,opts ] = conv_layer_2d_bp_bit( I,kernel,bias,stride,pad,dzdy,opts)
...
%          opts.I12=sign(I);
%          I=max(-1, min(1,I));
%          I1= binary_tanh_unit(I);
%         y_k=y.*I1;
        if PADDING_MODE==1
           pad=pad2;
           y=y(1+pad(1):pad(1)+i1,1+pad(3):pad(3)+i2,:,:);
        end
%         y_sk=BatchNorm(y_k,opts.l1,opts.l2,opts.parameters.batch_size);
