function [  net,res,opts ] = proxsvrg(  net,res,opts )
...
%         net.layers{1,layer}.weights{1, 6}=(net.layers{1, layer}.weights{1,6}+net.layers{1, layer}.weights{1,5}); %
...
%          net.layers{1,layer}.weights{1, 6}=(1/opts.n_train)*net.layers{1, layer}.weights{1,12};
%         end

%           net.layers{layer}.weights{2}=net.layers{layer}.weights{2}-opts.parameters.lr* res(layer).dzdb;
