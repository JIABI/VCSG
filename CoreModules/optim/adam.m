...
%   On the Importance of Consistency in Training Deep Neural Networks. arXiv preprint arXiv:1708.00631.
    ...
    for layer=1:numel(net.layers)
        if isfield(net.layers{layer},'weights')
            ...
            net.layers{layer}.weights{1}=net.layers{layer}.weights{1}-opts.parameters.l1_lr_2*net.layers{layer}.momentum{1} ...
            ...
            net.layers{layer}.weights{2}=net.layers{layer}.weights{2}-opts.parameters.l1_lr_2*net.layers{layer}.momentum{2} ...
