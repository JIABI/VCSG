...
% if opts.parameters.selective_sgd==1
    ...
    if ~isfield(opts.parameters,'lrs')
        ...
        if ~strcmp(func2str(opts.parameters.learning_method),'sgd2')&&~strcmp(func2str(opts.parameters.learning_method),'sgd2')
...
opts.dataDir=['/home/bonnie/LightNet-master/',opts.dataset_name,'/'];
opts=PrepareDataFunc(opts);
